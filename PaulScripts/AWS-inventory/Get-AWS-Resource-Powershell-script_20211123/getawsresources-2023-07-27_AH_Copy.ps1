...
$KeyFile = "C:\PersonalScripts\Get-AWS-Resource-Powershell-script_20211123\keyfile.txt"
...
Copy-Item -Force -Path C:\Reports\*.csv -Destination "\\gdcfs01\GeneralSoftware\_NE\AWSInventoryReports\"